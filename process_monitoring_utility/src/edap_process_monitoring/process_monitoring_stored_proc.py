...
class ProcessMonitoring:
    ...
    def insert_job_details(self):
        ...
        procedure_sql = (
            "EXEC sp_insert_job_details @_created=:_created, @_modified=:_modified, "
            "@env=:env, @job_name=:job_name, @frequency=:frequency, "
            "@load_type=:load_type, @source_system=:source_system, "
            "@source=:source, @source_type=:source_type"
        )

        self.call_stored_procedure(procedure_sql, param_dict, fetch_results=False, calling_module=this_module)
